            ...
            <div class="kh-tips questionnaire modal-container" slot="modal-container">
                ...
                <div class="content">
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-1" value='5'>A. 国有企事业单位</label>
                            <label>
                                <input type="radio" name="issue-1" value='2'>B. 非上市民营企业</label>
                            <label>
                                <input type="radio" name="issue-1" value='4'>C. 外资企业</label>
                            <label>
                                <input type="radio" name="issue-1" value='6'>D. 上市公司</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-2" value='1'>A.500 万元以下</label>
                            <label>
                                <input type="radio" name="issue-2" value='2'>B. 500 万元-2000 万元</label>
                            <label>
                                <input type="radio" name="issue-2" value='3'>C.2000 万元-1 亿元</label>
                            <label>
                                <input type="radio" name="issue-2" value='5'>D. 超过 1 亿元</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-3" value='1'>A.500 万元以下</label>
                            <label>
                                <input type="radio" name="issue-3" value='2'>B. 500 万元-3000 万元</label>
                            <label>
                                <input type="radio" name="issue-3" value='3'>C.2000 万元-1 亿元</label>
                            <label>
                                <input type="radio" name="issue-3" value='4'>D. 超过 1 亿元</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-4" value='1'>A. 300万以内</label>
                            <label>
                                <input type="radio" name="issue-4" value='2'>B. 300万元～1000万元</label>
                            <label>
                                <input type="radio" name="issue-4" value='3'>C. 1000万元～3000万元</label>
                            <label>
                                <input type="radio" name="issue-4" value='4'>D. 超过3000万元</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-5" value='3'>A. 银行贷款</label>
                            <label>
                                <input type="radio" name="issue-5" value='2'>B. 公司债券或企业债券</label>
                            <label>
                                <input type="radio" name="issue-5" value='1'>C. 通过担保公司等中介机构募集的借款</label>
                            <label>
                                <input type="radio" name="issue-5" value='0'>D. 民间借贷</label>
                            <label>
                                <input type="radio" name="issue-5" value='4'>E. 没有数额较大的债务</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-6" value='1'>A. 一名兼职人员（包括负责人自行决策）</label>
                            <label>
                                <input type="radio" name="issue-6" value='3'>B. 一名兼职人员</label>
                            <label>
                                <input type="radio" name="issue-6" value='4'>C. 多名兼职或专职人员，相互之间分工不明确</label>
                            <label>
                                <input type="radio" name="issue-6" value='5'>D. 多名兼职或专职人员，相互之间有明确分工</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-7" value='6'>A. 现在或此前曾从事金融、经济或财会等与金融产品投资相关的工作超过两年</label>
                            <label>
                                <input type="radio" name="issue-7" value='6'>B. 已取得金融、经济或财会等与金融产品投资相关专业学士以上学位</label>
                            <label>
                                <input type="radio" name="issue-7" value='6'>C. 取得证券从业资格、期货从业资格、注册会计师证书（ CPA）或注册金融分析师证书（ CFA）中的一项及以上</label>
                            <label>
                                <input type="radio" name="issue-7" value='0'>D. 本单位所配置的人员不符合以上任何一项描述</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-8" value='1'>A. 没有。因为要保证操作的灵活性</label>
                            <label>
                                <input type="radio" name="issue-8" value='3'>B. 已建立。包括了分工和授权的要求，但未包括投资风险控制的规则</label>
                            <label>
                                <input type="radio" name="issue-8" value='7'>C. 已建立。包括了分工与授权、风险控制等一系列与金融产品投资有关的规则</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-9" value='1'>A. 有限：除银行活期账户和定期存款外，基本没有其他投资经验</label>
                            <label>
                                <input type="radio" name="issue-9" value='2'>B. 一般：除银行活期账户和定期存款外，购买过基金、保险等理财产品，但还需要进一步的指导</label>
                            <label>
                                <input type="radio" name="issue-9" value='3'>C. 丰富：本单位具有相当投资经验，参与过股票、基金等产品的交易，并倾向于自己做出投资决策</label>
                            <label>
                                <input type="radio" name="issue-9" value='4'>D. 非常丰富：本单位对于投资非常有经验，参与过权证、期货或创业板等高风险产品的交易</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-10" value='1'>A. 太高了</label>
                            <label>
                                <input type="radio" name="issue-10" value='2'>B. 偏高</label>
                            <label>
                                <input type="radio" name="issue-10" value='3'>C. 正常</label>
                            <label>
                                <input type="radio" name="issue-10" value='4'>D. 偏低</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-11" value='1'>A. 5 个以下</label>
                            <label>
                                <input type="radio" name="issue-11" value='3'>B. 6 至 10 个</label>
                            <label>
                                <input type="radio" name="issue-11" value='4'>C. 11 至 15 个</label>
                            <label>
                                <input type="radio" name="issue-11" value='6'>D. 16 个以上</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="checkbox" name="issue-12" value='0'>A. 银行存款</label>
                            <label>
                                <input type="checkbox" name="issue-12" value='1'>B.债券、货币市场基金、债券型基金或其它固定收益类产品</label>
                            <label>
                                <input type="checkbox" name="issue-12" value='2'>C.股票、混合型基金、偏股型基金、股票型基金等权益类投资品种</label>
                            <label>
                                <input type="checkbox" name="issue-12" value='4'>D.期货、融资融券</label>
                            <label>
                                <input type="checkbox" name="issue-12" value='6'>E.复杂金融产品或其他产品</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-13" value='1'>A. 100 万元以内</label>
                            <label>
                                <input type="radio" name="issue-13" value='2'>B. 100 万元-300 万元</label>
                            <label>
                                <input type="radio" name="issue-13" value='3'>C. 300 万元-1000 万元</label>
                            <label>
                                <input type="radio" name="issue-13" value='4'>D. 1000 万元以上</label>
                            <label>
                                <input type="radio" name="issue-13" value='0'>E. 从未投资过金融产品</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-14" value='1'>A. 短期——0 到 1 年</label>
                            <label>
                                <input type="radio" name="issue-14" value='3'>B. 中期——1 到 5 年</label>
                            <label>
                                <input type="radio" name="issue-14" value='5'>C. 长期——5 年以上</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-15" value='0'>A. 资产保值，我不愿意承担任何投资风险</label>
                            <label>
                                <input type="radio" name="issue-15" value='2'>B. 尽可能保证本金安全，不在乎收益率比较低</label>
                            <label>
                                <input type="radio" name="issue-15" value='4'>C. 产生较多的收益，可以承担一定的投资风险</label>
                            <label>
                                <input type="radio" name="issue-15" value='6'>D. 实现资产大幅增长，愿意承担很大的投资风险</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="checkbox" name="issue-16" value='2'>A. 债券、货币市场基金、债券基金等固定收益类投资品种</label>
                            <label>
                                <input type="checkbox" name="issue-16" value='4'>B. 股票、混合型基金、偏股型基金、股票型基金等权益类投资品种</label>
                            <label>
                                <input type="checkbox" name="issue-16" value='5'>C. 期货、融资融券</label>
                            <label>
                                <input type="checkbox" name="issue-16" value='6'>D. 复杂金融产品</label>
                            <label>
                                <input type="checkbox" name="issue-16" value='6'> E. 其他产品</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-17" value='0'>A. 10%以内</label>
                            <label>
                                <input type="radio" name="issue-17" value='2'>B. 10%-30%</label>
                            <label>
                                <input type="radio" name="issue-17" value='4'>C. 30%-50%</label>
                            <label>
                                <input type="radio" name="issue-17" value='6'>D. 超过 50%</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-18" value='0'>A. 全部投资于 A</label>
                            <label>
                                <input type="radio" name="issue-18" value='1'>B. 大部分投资于 A</label>
                            <label>
                                <input type="radio" name="issue-18" value='3'>C. 两种投资各一半</label>
                            <label>
                                <input type="radio" name="issue-18" value='5'>D. 大部分投资于 B</label>
                            <label>
                                <input type="radio" name="issue-18" value='7'>E. 全部投资于 B</label>
                        </p>
                    </div>
                    <div class="issue">
                        ...
                        <p class="option">
                            <label>
                                <input type="radio" name="issue-19" value='3'>A. 闲置资金保值增值</label>
                            <label>
                                <input type="radio" name="issue-19" value='5'>B. 获取主营业务以外的投资收益</label>
                            <label>
                                <input type="radio" name="issue-19" value='4'>C. 现货套期保值、对冲主营业务风险</label>
                            <label>
                                <input type="radio" name="issue-19" value='1'>D. 减持已持有的股票</label>
                        </p>
                    </div>
                </div>
                <div class="btns">
